...
const articlesData = [
  {
    ...
    excerpt: "تحليل شامل للتطورات الجيوسياسية الحالية وتأثيرها على مستقبل المنطقة...",
  ...
  },
  {
    ...
    excerpt: "دراسة معمقة للتغيرات الاقتصادية والتحديات التي تواجه الدول العربية...",
  ...
  },
  {
    ...
    excerpt: "كيف غيرت التكنولوجيا وجه الدبلوماسية وما هي التحديات الجديدة...",
...
const opinionsData = [
  {
    ...
    excerpt: "رأي تحليلي حول القرارات المتخذة في القمة العربية وتأثيرها المحتمل...",
  ...
  },
  {
    ...
    excerpt: "تحليل للتحديات الأمنية الراهنة واقتراح حلول استراتيجية للمواجهة...",
...
const podcastsData = [
  {
    ...
    description: "نقاش معمق حول التحديات والفرص أمام الديمقراطية في المنطقة العربية...",
  ...
  },
  {
    ...
    description: "تحليل للأزمة الاقتصادية العالمية وانعكاساتها على الاقتصادات العربية...",
